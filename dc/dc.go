...
// MakeDealProposal is a paid mutator transaction binding the contract method 0xdd27fe90.
//
// Solidity: function makeDealProposal((bytes,uint64,bool,string,int64,int64,uint256,uint256,uint256,uint64,(string,uint64,bool,bool)) deal) returns()
